...
import { onAuthStateChanged, createUserWithEmailAndPassword, signInWithEmailAndPassword, signOut,getAuth, deleteUser  } from "https://www.gstatic.com/firebasejs/12.8.0/firebase-auth.js";
import { getFirestore, doc, setDoc, getDoc, collection, query, where, deleteDoc, getDocs } from "https://www.gstatic.com/firebasejs/12.8.0/firebase-firestore.js";
...
async function updatedetails(details, uid, collection) {
  try {
...
async function deleteUserfirestore(collection,uid) {
...
export { signup,deleteUserfirestore,deleteUserfirebase, updatedetails, login, addUserDetails, getuserdetails, alluserdetail, getCurrentUser, logOutUser }
